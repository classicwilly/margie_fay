...
3. Scopes: By default we request `openid email profile` plus Drive/Calendar/Sheets/Gmail scopes to enable seamless automation from the user’s account. Consider least-privilege and request only what you need.

4. Start the server and dev environment
