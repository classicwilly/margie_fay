...
async function appendRow(spreadsheetId, range, values) {
  return sheets.spreadsheets.values.append({ spreadsheetId, range, valueInputOption: 'USER_ENTERED', resource: { values } });
}
// Usage: 
...
await calendar.events.insert({ calendarId: 'primary', requestBody: {
  summary: 'Family Morning Routine', start: { dateTime: '2025-12-01T07:00:00-08:00' }, end: { dateTime: '2025-12-01T07:30:00-08:00' },
