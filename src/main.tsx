  ...
  if (typeof window !== "undefined") {
    ...
    try {
      ...
      if (earlyInit && typeof earlyInit === "object") {
        ...
        if (earlyInit.dashboardType === "william") {
          ...
          console.info(
            "PREHYDRATE: __WONKY_TEST_INITIALIZE__ dashboardType=william — forcing GameMaster",
          );
          try {
            (window as any).__WONKY_E2E_LOG_PUSH__(
    ...
    try {
      ...
      if (earlyInit && typeof earlyInit === "object") {
        ...
        console.info(
          "PREHYDRATE: __WONKY_TEST_INITIALIZE__ present — enabling PLAYWRIGHT_SKIP_DEV_BYPASS",
        );
      }
    } catch (e) {
      /* ignore */
    ...
    try {
      ...
      if (raw) {
        ...
        // eslint-disable-next-line no-console
        console.info("PREHYDRATE: seed found — skip dev bypass enabled", {
          seedKey,
        });
      }
    } catch (e) {
