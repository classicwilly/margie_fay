          ...
          <ContentCard title="Step 4: Guided Reflection & Planning">
            ...
            <div className="space-y-4">
              <textarea
                ...
                placeholder="✅ What went well this week? (Wins)"
                rows={4}
              ...
              <textarea
                ...
                placeholder="⚠️ What created friction or failed? (Friction Points)"
                rows={4}
                className="w-full p-2 bg-gray-800 border border-gray-600 rounded"
              />
              <textarea
                ...
                placeholder="🎯 What is the single most important focus for next week?"
                rows={2}
                className="w-full p-2 bg-gray-800 border border-gray-600 rounded"
              />
            </div>
