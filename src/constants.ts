...
export const SOP_DATA = [
  {
    ...
    description:
      "The core 5 protocols required for system stability and daily function. Execute sequentially without deviation.",
    steps: [
  ...
  },
  {
    ...
    description:
      "Optimized for deep work and focused output. Strictly adhere to hourly blocks. Minimize distractions. This is not a suggestion.",
  },
  {
    id: "3",
    category: "M4_SOP",
    ...
    description:
      "High-vigilance parenting and structured family engagement. Predictability is comfort. Prioritize children (P5).",
  },
  {
    id: "4",
    category: "M4_SOP",
    ...
    description:
      'A mandate for absolute quality and precision. No ambiguity. No placeholders. This defines "done."',
  },
  {
    id: "5",
    category: "M4_IPI",
    ...
    description:
      "Protocol for managing acute sensory or executive function overload. Prioritize immediate stabilization. This is an emergency procedure.",
  },
  {
    id: "6",
    category: "M4_SOP",
    ...
    description:
      "A structured sequence to bridge the gap between sleep and active execution, minimizing cognitive fog and decision paralysis.",
  },
  {
    id: "7",
    category: "M4_SOP",
    subCategory: "hardware",
    viewId: "workshop-setup",
    title: "Workshop Setup",
    description:
      "Defines the required hardware, software, and spatial layout for an optimized, low-friction workspace.",
  },
  {
    id: "8",
    category: "M4_SOP",
    ...
    description:
      "Configuration for the mobile extension of the OS, focused on chaos capture and continuity.",
  },
  {
    id: "9",
    category: "M4_SOP",
    ...
    description:
      "Systematizes essential survival tasks: house cleaning, groceries, and personal hygiene, treating them as mechanical systems.",
    taskTemplate: [
      {
  ...
  },
  {
    ...
    description:
      "A tiered system matching hygiene tasks to available capacity, removing shame and executive function barriers.",
  },
  {
    id: "11",
    category: "M4_SOP",
    ...
    description:
      "Mandates the use of sensory mitigation hardware (e.g., noise-cancelling headphones) as non-negotiable assistive technology.",
  },
  {
    id: "12",
    category: "M4_SOP",
    ...
    description:
      "Ensures the OS itself is safe, stable, and usable for neurodivergent users by defining accessibility standards.",
  },
  {
    id: "13",
    category: "M4_IPI",
    ...
    description:
      "A rapid protocol to capture cognitive state, handle interruptions, and restore context with minimal cognitive load.",
  },
  {
    id: "14",
    category: "M4_IPI",
    ...
    description:
      "An emergency reboot for when tasks feel impossible, designed to restore basic operational capacity when frozen.",
  },
  {
    id: "17",
    category: "M4_IPI",
    ...
    description:
      "Reverse engineer Soundcore Bluetooth commands to build a structured desktop controller and fix the chaos of the mobile-only app.",
  },
  {
    id: "18",
    category: "KIDS_SOP",
    ...
    description:
      "A structured system for low-friction, high-clarity communication and logistics with the co-parent. Focus on facts, not feelings.",
  },
  {
    id: "19",
    category: "M4_SOP",
    ...
    description:
      "Guidelines for interacting with AI systems, ensuring data privacy, ethical use, and mental well-being.",
  },
  {
    id: "20",
    category: "M4_SOP",
    ...
    description:
      "A meta-protocol to prevent ad-hoc changes by enforcing a structured, diagnostic-first approach to all system modifications. Complacency kills.",
  },
  {
    id: "21",
    category: "M4_SOP",
    ...
    description:
      "An SOP that defines the visual and interaction principles, color palette, typography, and component standards of the OS.",
  },
  {
    id: "22",
    category: "M4_SOP",
    ...
    description:
      "Comprehensive guide to the build system, architecture, state management, and troubleshooting procedures for developers.",
  },
  {
    id: "23",
    category: "M4_SOP",
    ...
    description:
      "The comprehensive user's guide to the Wonky Sprout OS, explaining all core features and concepts.",
  },
  {
    id: "24",
    category: "M4_SOP",
    ...
    description:
      "The SOP for deploying the OS to Firebase Hosting, transitioning it from development to a live state.",
  },
];

// Airlock protocol duration in milliseconds
export const AIRLOCK_DURATION_MS = 60000; // 60s

// Backwards-compatible alias (naming migration): E-Stop
export const ESTOP_DURATION_MS = AIRLOCK_DURATION_MS;
...
export const REWARD_TIERS = [
  ...
  },
  {
    ...
    description:
      "Get 30 extra minutes for games or videos, to be used this weekend.",
  },
  {
    threshold: 20,
    emoji: "🎬",
  ...
  },
  {
    ...
    description:
      "You collected ALL the gems! Time for a special talk with Dad about a bigger prize.",
  },
];

export const ALL_ACHIEVEMENTS = [
  {
    id: "foundational-day-complete",
    emoji: "🪨",
    label: "Foundation Set",
    description: "Completed all Foundational Daily Protocols in a single day.",
  },
  {
    id: "weekly-review-complete",
    emoji: "📊",
    label: "System Analyst",
    description: "Completed a Weekly Review, analyzing and calibrating the OS.",
  },
  {
    id: "inbox-zero",
    emoji: "📭",
    label: "Inbox Zero",
    description: "Cleared all items from the Task Matrix inbox.",
  },
  {
    id: "first-sop-created",
    emoji: "🏗️",
    label: "System Architect",
    description: "Created your first custom Standard Operating Procedure.",
  },
  {
    id: "first-focus-session",
    emoji: "🎯",
    label: "Focused Power",
    description: "Completed your first Focus Mode session in the Task Matrix.",
  },
  {
    id: "project-complete",
    emoji: "🏁",
    label: "Project Complete!",
    description: "Finished and archived your first strategic project.",
  },
  {
    id: "all-systems-green",
    emoji: "✅",
    label: "All Systems Green",
    description: "Achieved a Sprout Health Score of 100.",
  },
  {
...
export const ADULT_REWARD_TIERS = [
  {
    ...
    description:
      "Permission for 1 hour of uninterrupted, guilt-free time on a personal project.",
  },
  {
    threshold: 4,
    emoji: "💸",
    ...
    description:
      "Authorize a purchase of a new tool or piece of tech up to $50.",
  },
  {
    ...
    description:
      "Schedule a full day with zero obligations. True system downtime.",
  },
];
...
const staticWilliamModules: ModuleConfig[] = [
  {
    id: "daily-briefing-module",
    name: "Daily Command Module",
    description:
      "A unified daily dashboard combining AI summary, critical tasks, today's agenda, and daily habits.",
    defaultEnabled: true,
    isRemovable: false,
    category: "core",
  ...
  },
  {
    ...
    name: "Task Matrix",
    description:
      "A comprehensive task management system for all non-recurring tasks. Your central inbox for action items.",
    defaultEnabled: true,
    isRemovable: false,
    category: "core",
  ...
  },
  {
    ...
    description:
      "Visual representation of daily progress from 6 AM to 10:30 PM.",
    defaultEnabled: true,
    isRemovable: true,
    category: "trackers",
  ...
  },
  {
    ...
    description:
      "Log your sensory state to identify patterns of over/under-stimulation.",
    defaultEnabled: false,
    isRemovable: true,
    category: "trackers",
  ...
  },
  {
    ...
    description:
      "Define and track core habits to build consistency and reinforce routines.",
    defaultEnabled: false,
    isRemovable: true,
    category: "trackers",
  ...
  },
  {
    ...
    description:
      "A low-friction system for capturing and categorizing expenses.",
    defaultEnabled: false,
    isRemovable: true,
    category: "trackers",
  ...
  },
  {
    ...
    description:
      "Automated tracking for periodic life maintenance tasks (e.g., bills, appointments).",
    defaultEnabled: false,
    isRemovable: true,
    category: "utilities",
  ...
  },
  {
    ...
    description:
      "Set monthly budgets and track spending against them for a high-level financial overview.",
    defaultEnabled: false,
    isRemovable: true,
    category: "trackers",
  ...
  },
  {
    ...
    description:
      "Define and track long-term goals (Objectives) and their component parts (Projects), linking them to daily tasks.",
    defaultEnabled: false,
    isRemovable: true,
    category: "utilities",
  ...
  },
  {
    ...
    name: "The Observer",
    description:
      "Text-based conversation with The Observer for problem-solving.",
    defaultEnabled: true,
    isRemovable: true,
    category: "utilities",
  ...
  },
  {
    ...
    name: "Workshop",
    description:
      "Profile & preferences manager for audio/ornamental/visual stacks. Create, apply, and manage attention-friendly stacks.",
    defaultEnabled: true,
    isRemovable: true,
    category: "core",
    icon: "M12 2a10 10 0 100 20 10 10 0 000-20zm1 15l-5-3 5-3v6z",
  },
  {
    id: "live-chat-module",
    name: "Observer Live Chat",
    description:
      "Real-time voice conversation with The Observer for hands-free problem-solving.",
    defaultEnabled: false,
    isRemovable: true,
    category: "utilities",
  ...
  },
  {
    ...
    description:
      "Store and quickly retrieve small, critical pieces of information like passwords or model numbers.",
    defaultEnabled: false,
    isRemovable: true,
    category: "utilities",
  ...
  },
  {
    ...
    description:
      "A searchable vault for insights, notes, and processed knowledge. Your personal second brain.",
    defaultEnabled: false,
    isRemovable: true,
    category: "utilities",
  ...
  },
  {
    ...
    name: "Pomodoro Timer",
    description:
      "A simple focus timer to help with task initiation and management.",
    defaultEnabled: false,
    isRemovable: true,
    category: "utilities",
  ...
  },
  {
    ...
    description:
      'Displays the SOPs you have marked as "active" for quick reference and execution.',
    defaultEnabled: false,
    isRemovable: true,
    category: "content",
  ...
  },
  {
    ...
    description:
      "Select which SOPs you want to see displayed in the Active SOPs module.",
    defaultEnabled: false,
    isRemovable: true,
    category: "selection",
  ...
  },
  {
    ...
    description:
      "A collection of simple, interactive tools for sensory input and regulation.",
    defaultEnabled: false,
    isRemovable: true,
    category: "utilities",
...
const checklistModules = ALL_CHECKLIST_DATA.reduce(
  (acc: ModuleConfig[], section) => {
...
export const ALL_WILLOW_MODULES_CONFIG = [
  {
    ...
    description:
      "Shows the current family mode (e.g., Family Time) and what's happening now.",
    defaultEnabled: true,
    isRemovable: false,
    category: "core",
  },
  {
    ...
    name: "Quest Log",
    description:
      "Special missions from Dad! Complete all the steps to earn a big reward.",
    defaultEnabled: true,
    isRemovable: false,
    category: "quests",
  },
  ...
  },
  {
    ...
    name: "Dopamine Cache",
    description:
      "Willow's dopamine cache and progress towards sensory rewards.",
    defaultEnabled: true,
    isRemovable: false,
    category: "rewards",
  },
  {
    ...
    name: "Dopamine Mining",
    description: "Redeem sensory rewards using your collected dopamine.",
    defaultEnabled: true,
    isRemovable: true,
    category: "rewards",
  },
...
export const ALL_SEBASTIAN_MODULES_CONFIG = [
  ...
  },
  {
    ...
    name: "Daily Checklists",
    description:
      "Sebastian's daily and weekly checklists for routines and tasks.",
    defaultEnabled: true,
    isRemovable: false,
    category: "checklists",
  },
  {
    ...
    name: "Dopamine Cache",
    description:
      "Sebastian's dopamine cache and progress towards sensory rewards.",
    defaultEnabled: true,
    isRemovable: false,
    category: "rewards",
  },
...
export const ALL_CO_PARENTING_MODULES_CONFIG = [
  {
    ...
    description:
      "Translate your direct thoughts into collaborative, low-conflict messages for your co-parent.",
    defaultEnabled: true,
    isRemovable: false,
    category: "core",
  },
  {
    ...
    description:
      "A single source of truth for all child-related appointments, events, and handoffs.",
    defaultEnabled: true,
    isRemovable: false,
    category: "core",
  },
  {
    ...
    description:
      "A persistent log for important, non-urgent information like medication updates or school notes.",
    defaultEnabled: true,
    isRemovable: true,
    category: "logging",
  },
  {
    ...
    description:
      "Centralized, editable profiles for each child with critical information (allergies, contacts).",
    defaultEnabled: true,
    isRemovable: true,
    category: "info",
  },
  {
    ...
    description:
      "Track and manage shared expenses for the children to ensure fairness and transparency.",
    defaultEnabled: false,
    isRemovable: true,
    category: "info",
  },
  {
    ...
    description:
      "A structured checklist to prepare for a smooth handoff, with an AI-generated summary.",
    defaultEnabled: false,
    isRemovable: true,
    category: "handoffs",
  },
