...
export const initialMemorials: MemorialEntry[] = [
  {
    ...
    excerpt:
      "Margie was a WWII riveter, homemaker, bowler, and matriarch. Practical, loving, and firm.",
    photo: "/grandma.svg",
  },
  {
    ...
    excerpt:
      "Robert faithfully served his country, founded American Legion Baseball in Pryor, and loved his family.",
    photo: "/grandpa.png",
  },
];
