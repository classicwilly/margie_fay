      ...
      >
        ...
        <div className="p-4 bg-red-900/30 rounded-lg border border-red-700">
          <p className="font-bold text-red-300 text-lg">
            ⚠️ System Overwrite Warning!
          </p>
          <p className="text-red-300 mt-2">
            You are about to import a new OS state from a backup file. This
            action will completely and irreversibly overwrite all of your
            current data, including checklists, tasks, habits, financial
            records, and knowledge vault entries.
          </p>
