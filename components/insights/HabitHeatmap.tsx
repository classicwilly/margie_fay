...
const HabitHeatmap = () => {
    ...
    if (habits.length === 0) {
        return <ContentCard title="Habit Compliance (Last 30 Days)"><p className="text-text-light text-opacity-80 text-center p-4">No habits are being tracked. Add habits via the Habit Streak Tracker module.</p></ContentCard>;
    }
