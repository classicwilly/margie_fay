...
const SopVault: React.FC = () => {
  ...
  const { dispatch } = (typeof useAppState === 'function' ? useAppState() : { dispatch: () => {} });
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <section className="mb-10">
        <div className="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4">
          ...
          <div className="flex gap-2">
            <Button className="flex items-center flex-shrink-0" variant="primary" aria-label="Create a new protocol">
              Create New Protocol
            </Button>
            <Button
      ...
      <section>
        <h3 className="text-2xl font-bold text-accent-green mb-4">Foundational Protocols</h3>
        <p className="text-lg text-text-light text-opacity-80 mb-6">Core, repeatable systems for managing daily operations and maintaining stability.</p>
        {/* Example protocol cards, replace with dynamic rendering as needed */}
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          <div className="card-base">
            <h4 className="font-bold text-accent-teal mb-2">Foundational Daily Protocol</h4>
            <p className="text-text-light text-opacity-80">The core 5 protocols required for system stability. Execute sequentially without deviation.</p>
          </div>
          <div className="card-base">
            <h4 className="font-bold text-accent-teal mb-2">Morning Transition Protocol</h4>
            <p className="text-text-light text-opacity-80">A structured sequence to bridge the gap between sleep and active mode.</p>
          </div>
          <div className="card-base">
            <h4 className="font-bold text-accent-teal mb-2">Solo Execution Mode</h4>
            <p className="text-text-light text-opacity-80">Optimized for deep work and focused output. Strictly adhere to hourly blocks. Minimize distractions.</p>
          </div>
        </div>
      </section>
    </div>
