        ...
        <ContentCard title="🗂️ Quick Reference Vault">
            <div className="flex flex-col h-full">
                <p className="text-sm text-text-light text-opacity-80 mb-3">
                    ...
                    <label htmlFor="quickref-search" className="sr-only">Search quick reference</label>
                    <input
                    type="text"
                    id="quickref-search"
                ...
                <form onSubmit={handleAddEntry} className="mt-auto pt-3 border-t border-gray-700 space-y-2">
                    ...
                    <label htmlFor="quickref-key" className="sr-only">Key</label>
                    <input
                        type="text"
                        id="quickref-key"
                        ...
                        required
                    />
                    <label htmlFor="quickref-value" className="sr-only">Value</label>
                    <input
                        type="text"
                        id="quickref-value"
