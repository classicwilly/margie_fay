            ...
            <div className="flex flex-col h-full">
                ...
                <form onSubmit={handleSubmit} className="mt-auto pt-3 border-t border-gray-700 space-y-2">
                    ...
                    <div className="flex gap-2">
                        <label htmlFor="recurring-frequency" className="sr-only">Frequency in days</label>
                        <input id="recurring-frequency" type="number" value={frequencyDays} onChange={e => setFrequencyDays(e.target.value)} className="w-1/2 p-2 bg-gray-900 border border-gray-600 rounded" required min="1" placeholder="Repeats every (days)..." />
                        <label htmlFor="recurring-start" className="sr-only">Start date</label>
                        <input id="recurring-start" type="date" value={startDate} onChange={e => setStartDate(e.target.value)} className="w-1/2 p-2 bg-gray-900 border border-gray-600 rounded" required />
                    </div>
