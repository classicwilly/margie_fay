...
const PixelFoldSetupSop: React.FC = () => {
  const protocolData = ALL_CHECKLIST_DATA.filter(
    (s) => s.sourceDocument === "Pixel Fold Setup SOP",
  );
    ...
    <div>
      <header className="text-center mb-10">
        ...
        <p className="text-lg text-text-light text-opacity-80">
          Configure the mobile extension of the Wonky Sprout OS for chaos
          capture, continuity, and emergency access.
        </p>
      </header>
      ...
      <div className="space-y-6">
        ...
        <footer className="text-center mt-12 pt-8 border-t border-gray-700">
          <p className="text-xl font-bold text-accent-blue">
            The Pixel Fold is a tool, not a toy. It extends the Command Center
            into your pocket. Every setting serves the dual-mode life structure.
          </p>
        </footer>
      </div>
    </div>
