...
const Workshop: React.FC = () => {
    ...
    const AskGrandmaFloatingLazy = React.lazy(() => import('./AskGrandmaFloating'));
  ...
  return (
    <div className="container mx-auto px-4 py-8 space-y-8" data-workshop-testid="main-content">
        ...
        <DeepFocusContainer active={appState?.isFocusModeActive}>
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
            <div className="mb-4 md:mb-0">
              ...
              <h1 data-workshop-testid="workshop-title" className="text-5xl font-extrabold text-accent-teal mt-2">
            ...
            <div className="flex flex-col items-end">
              ...
              <div className="card-base px-4 py-2 rounded-full flex items-center space-x-2">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-zap text-accent-teal">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <ContentCard title="Workspace Launchpad">
          ...
          <div className="mt-4 flex gap-2">
            <Button data-testid="test-airlock-btn" data-workshop-testid="test-estop-btn" variant="danger" className="font-bold" onClick={handleTestAirlock}>
