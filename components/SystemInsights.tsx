    ...
    <div>
      <header className="text-center mb-10">
        ...
        <p className="text-lg text-text-light text-opacity-80 max-w-3xl mx-auto">
          A high-level analytics dashboard for the entire OS. Visualize trends
          and review automated AI diagnostics to find correlations.
        </p>
      </header>

      <section id="ai-diagnostics" className="mb-12">
        <h2 className="text-3xl font-bold text-accent-green mb-6 text-center border-b-2 border-gray-700 pb-2">
          AI Diagnostics
        </h2>
      ...
      <section id="financial-cockpit" className="mb-12">
        <h2 className="text-3xl font-bold text-accent-green mb-6 text-center border-b-2 border-gray-700 pb-2">
          Financial Workshop
        </h2>
