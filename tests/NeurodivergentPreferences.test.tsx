...
import { NeurodivergentPreferences } from '../../src/components/NeurodivergentPreferences';
...
describe('NeurodivergentPreferences', () => {
  it('Changing assist tone updates preference', () => {
    ...
    render(<NeurodivergentPreferences />);

    // Flexible label selector for "Assist Tone" or "Observer Voice"
